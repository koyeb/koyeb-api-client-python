    ...
    def make_instance(self, include_optional) -> GetOrganizationReply:
        ...
        if include_optional:
            return GetOrganizationReply(
                organization = koyeb.models.represent_an_organization.Represent an Organization(
                    id = '', 
                    address1 = '', 
                    address2 = '', 
                    city = '', 
                    ...
                    signup_qualification = koyeb.models.signup_qualification.signup_qualification(), 
                    status = 'WARNING', 
                    status_message = 'NEW', 
