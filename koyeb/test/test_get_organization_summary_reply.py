    ...
    def make_instance(self, include_optional) -> GetOrganizationSummaryReply:
        ...
        if include_optional:
            return GetOrganizationSummaryReply(
                summary = koyeb.models.organization_summary.OrganizationSummary(
                    organization_id = '', 
                    instances = koyeb.models.instances_summary.InstancesSummary(
                        total = '', 
                        by_type = {
                            'key' : ''
                            }, ), 
                    apps = koyeb.models.apps_summary.AppsSummary(
                        total = '', 
                        by_status = {
                            'key' : ''
                            }, ), 
                    services = {
                        'key' : koyeb.models.service_summary.ServiceSummary(
                            total = '', 
                            by_status = {
                                'key' : ''
                                }, )
                        }, 
                    domains = koyeb.models.domains_summary.DomainsSummary(
                        total = '', 
                        by_status = {
                            'key' : ''
                            }, ), 
                    secrets = koyeb.models.secrets_summary.SecretsSummary(
                        total = '', 
                        by_type = {
                            'key' : ''
                            }, ), 
                    neon_postgres = koyeb.models.neon_postgres_summary.NeonPostgresSummary(
                        total = '', 
                        by_instance_type = {
                            'key' : ''
                            }, ), 
                    members = koyeb.models.members_summary.MembersSummary(
                        total = '', 
