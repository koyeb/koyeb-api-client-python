...
class DeploymentScalingTarget(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "average_cpu": DeploymentScalingTargetAverageCPU.from_dict(obj.get("average_cpu")) if obj.get("average_cpu") is not None else None,
            "average_mem": DeploymentScalingTargetAverageMem.from_dict(obj.get("average_mem")) if obj.get("average_mem") is not None else None,
            "requests_per_second": DeploymentScalingTargetRequestsPerSecond.from_dict(obj.get("requests_per_second")) if obj.get("requests_per_second") is not None else None
        })
        return _obj
