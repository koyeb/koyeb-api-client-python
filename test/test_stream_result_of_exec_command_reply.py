    ...
    def make_instance(self, include_optional) -> StreamResultOfExecCommandReply:
        ...
        if include_optional:
            return StreamResultOfExecCommandReply(
                result = koyeb.models.exec_command_reply.ExecCommandReply(
                    stdout = koyeb.models.exec_command_io.ExecCommandIO(
                        data = 'YQ==', 
                        close = True, ), 
                    stderr = koyeb.models.exec_command_io.ExecCommandIO(
                        data = 'YQ==', 
                        close = True, ), 
                    exited = True, 
                    exit_code = 56, ),
                error = koyeb.models.google/rpc/status.google.rpc.Status(
                    code = 56, 
                    message = '', 
                    details = [
                        {
