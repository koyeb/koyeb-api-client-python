    ...
    def make_instance(self, include_optional) -> NotificationList:
        ...
        if include_optional:
            return NotificationList(
                notifications = [
                    koyeb.models.notification.Notification(
                        id = '', 
                        activity = koyeb.models.activity.Activity(
                            id = '', 
                            actor = koyeb.models.object.Object(
                                id = '', 
                                name = '', 
                                type = '', 
                                metadata = koyeb.models.metadata.metadata(), 
                                deleted = True, ), 
                            object = koyeb.models.object.Object(
                                id = '', 
                                name = '', 
                                type = '', 
                                metadata = koyeb.models.metadata.metadata(), 
